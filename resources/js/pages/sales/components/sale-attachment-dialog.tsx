                    ...
                    {displaySrc ? (
                        <div className="relative rounded-md border bg-muted/30 p-2">
                            <Button
                                ...
                                variant="secondary"
                                size="icon"
                                className="absolute right-3 top-3 z-10 h-8 w-8 shadow-md"
                                title="Zoom image"
            ...
            <DialogContent className="flex max-h-[92vh] w-auto max-w-[calc(100vw-2rem)] flex-col gap-2 overflow-hidden p-3 sm:max-w-[calc(100vw-2rem)] sm:p-4">
                <DialogHeader className="shrink-0">
                    ...
                    <DialogDescription className="sr-only">
                        Image shown at its saved pixel dimensions. Scroll if it
                        is larger than the window. Close with the dialog button
                        or Escape.
                    </DialogDescription>
                </DialogHeader>
                {displaySrc && (
                    <div className="min-h-0 min-w-0 max-h-[min(88vh,calc(92vh-3.5rem))] max-w-[min(95vw,calc(100vw-2.5rem))] overflow-auto rounded-md border bg-muted/20 p-1">
                        <img
                            src={displaySrc}
                            alt=""
