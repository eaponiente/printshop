                                ...
                                <AlertDialog>
                                    ...
                                    <AlertDialogContent>
                                        <AlertDialogHeader>
                                            ...
                                            <AlertDialogDescription>
                                                {period.status === 'approved'
                                                    ? 'This will delete the approved payroll period, restore any cash-advance deductions it made, unlock all attendance sheets, and remove all payroll items. This cannot be undone.'
